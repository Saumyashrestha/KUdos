  ...
  return (
    <Layout>
      <div className="flex justify-center items-center py-10">
        {/* Scorecard Container */}
        <div className="bg-[#bfbfbf] shadow-md rounded-lg border border-[#387478] p-8 w-[90%] max-w-4xl">
          <div className="flex justify-between items-center px-10">
            ...
            <div className="text-center space-y-4">
              ...
              />
              <h3 className="font-semibold text-xl text-white">Man City</h3>
          ...
          <div className="flex justify-center gap-20 mt-4 mb-0">
            <button className="text-white hover:text-[#387478] text-lg font-semibold border-b-2 border-transparent hover:border-[#387478]">
              Lineup
            </button>
            <button className="text-white hover:text-[#387478] text-lg font-semibold border-b-2 border-transparent hover:border-[#387478]">
              Result

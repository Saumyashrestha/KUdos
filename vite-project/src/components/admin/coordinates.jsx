      ...
      {activeTab === 'list' ? (
        <Card className="bg-white">
          <CardHeader>
            ...
            <CardDescription>
              Showing {coordinators.length} coordinators
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {coordinators.map((coordinator) => (
                <div key={coordinator.id} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors duration-200">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="relative">
                     <button
                                            onClick={() => setOpenDropdown(openDropdown === coordinator.id ? null : coordinator.id)}
                                            className={`px-3 py-1.5 rounded-lg text-sm flex items-center gap-2 border transition-all duration-200 ${getStatusStyle(coordinator.status)}`}
                                          >

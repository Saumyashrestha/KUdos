const OrderDetail = () => {
    return (
        <div>
            ...
            <div className="py-5">
                {/* text  */}
                <h1 className=" text-xl text-[#387478] font-bold">All Orders</h1>
            </div>
                ...
                <table className="w-full text-left border border-collapse sm:border-separate border-gray-500 text-[#4c9da3]" >
                    <tbody>
                        <tr>
                            ...
                            <th scope="col" className="h-12 px-6 text-md font-bold fontPara border-l first:border-l-0 border-gray-500 text-slate-700 bg-slate-100">Quantity</th>
                            <th scope="col" className="h-12 px-6 text-md font-bold fontPara border-l first:border-l-0 border-gray-500 text-slate-700 bg-slate-100">Status</th>
                        </tr>

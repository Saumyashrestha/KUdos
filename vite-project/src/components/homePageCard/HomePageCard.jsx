        ...
        <div className="container px-5 py-5 mx-auto space-y-6">
          ...
          {getAllMatches.map((match) => {
            ...
            return (
              ...
              >
                <div className="relative w-full flex justify-between items-center px-28 py-8">
                  {/* Left Team */}
                  <div className="text-center space-y-4">
                    <img
                      className="h-30 w-32 object-cover mx-auto filter drop-shadow-md"
                      src="/mancity.png" 
          ...
          {activeEvents.map((event) => (
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                {userDetails.email === event.userEmail && (
                  <button 
